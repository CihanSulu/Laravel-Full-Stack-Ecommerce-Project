...
$(document).on("click", ".varyantSil" , function() {
    $(this).parent().parent().remove();
});
$("#varyantEkle").click(function(){
    const html = '<tr><td><input type="text" value="" class="form-control" name="varyantRenk[]"></td><td><input type="text" value="" class="form-control" name="varyantBoyut[]"></td><td><input type="text" value="" class="form-control" name="varyantFiyat[]" required></td><td><img id="image" style="" /><input accept="image/*" type="file" name="varyantResim[]" class="imagefiles"/</td><td><a href="javascript:void(0);" class="varyantSil">Varyantı Sil</a></td></tr>';
    $("#varyantlar tbody").append(html);
    $("#novariant").hide();
});
$(document).on("change", ".imagefiles" , function() {
    var src = URL.createObjectURL(this.files[0]);
    $(this).prev().css({"height":"100px","marginBottom":"20px","display":"block","borderRadius":".25rem"});
